	...
	paths: {
		...
		'/jokes/create': {
			parameters: [
				{
					...
					description: 'A comma separated list of topics.',
				},
				{
					$ref: '#/components/parameters/max-length',
				},
			...
			get: {
				...
				responses: {
					'200': {
						description: 'Joke Creation Response',
						content: {
							'application/json': {
								schema: {
									description: '',
				...
				operationId: 'create-joke',
				description: 'Create a joke.\nSee https://humorapi.com/docs/#Create-Joke for more.',
			},
		},
		'/jokes/analyze': {
			post: {
	...
	components: {
		...
		parameters: {
			...
			'media-type': {
				...
				schema: {
					type: 'string',
					enum: ['image', 'video', 'jpg', 'gif', 'png', 'mp4'],
					example: 'image',
				},
